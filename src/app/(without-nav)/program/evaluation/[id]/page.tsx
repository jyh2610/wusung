  ...
  const handlePrint = async () => {
    try {
      ...
      if (pdfUrl) {
        ...
        iframe.style.pointerEvents = 'none'; // 마우스 이벤트 무시 // 추가: 마우스 이벤트 방지
          ...
          setTimeout(() => {
            ...
            if (iframe.contentWindow) {
              try {
                ...
                // 사용자가 인쇄창을 닫으면 아이프레임과의 연결이 해제되므로
